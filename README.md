...
- **📱 Totalmente Responsivo**: Diseño adaptable para ofrecer una experiencia visual ideal desde dispositivos móviles, tablets y hasta ordenadores de escritorio.
...
- **Vite**: Entorno de desarrollo rápido y empaquetador de última generación.
- **Tailwind CSS**: Framework de utilidad para el diseño rápido y responsivo.
...
- **Context API**: Gestión del estado global de la aplicación, incluyendo el tema (Claro/Oscuro).
...
4. **Abre la aplicación** en tu navegador en la dirección indicada por Vite (generalmente `http://localhost:5173`).
